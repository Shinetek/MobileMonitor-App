...
angular.module('starter.controllers', [])
  ...
  .controller('GroundSystemCtrl',function($scope, Systems, Sensors, SQLiteService){
  ...
  .controller('FastViewDetailCtrl', function($scope, $stateParams, $http, $q, $ionicLoading,  HTTPGET) {
  ...
  .controller('FastViewCtrl',function($scope, $http, $q, $ionicLoading, HTTPGET){
